...
# Lab 05-00
#
# This file creates the VideoGame and BounceDemo class that build scenes.
#
...
class BounceDemo(VideoGame):
    ...
    def build_scene_graph(self):
        ...
        credits_string = 'Bouncing Balls by Pedro Morales Sound Effects: Monkey.aiff and Boing.aiff from Mac OS 7. Soundtrack: Jack Pearcy, "Warm Rays, Good Waves", Deep Lake Records. Images: explosion1.gif from Pygame.'
        self._scene_graph = [
            BlinkingTitle(
                self._screen,
                self._title,
